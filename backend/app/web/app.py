...
async def lifespan(app: FastAPI):
    ...
    from backend.app.db.stock_tables import init_cache_tables, migrate_add_hidden_to_custom_sectors, create_master_stocks_table, migrate_master_stocks_table_pk, create_stock_5d_bars_table, migrate_add_buy_date_to_trades, migrate_add_buy_reason_columns_to_trades, migrate_add_raw_payload_to_stock_5d_bars, migrate_drop_raw_status_columns
    ...
    # --- shutdown ---
    # 종료 직후 새 시간표 작업이 예약되지 않도록 타이머부터 중지한다.
