...
## 세션 개요
- 날짜: 2026-07-15 (상단 요약 배지 위계 분리 + 색상/라벨 일관성 개선)
- 작업: 보유종목·매수후보 페이지 상단 요약 배지(숫자 카드)의 숫자 기본색 빨강→검정 근본 해결, 위계 분리(숫자 중심/라벨·단위 보조), 중앙 정렬+간격 확대, 종목 수 파란색 강조, 보유종목 배지 라벨 자세하게 통일.
