...
- 사용자에게 보고: "조사 완료. 보고서: `docs/조사보고서/<주제>_<날짜>.md`. 발견 <N>건."
  > **보고 형식**: docs/절차규칙/절차규칙_보고_상세.md '조사/의견 제시 세션' 표 세트(표 1 변경 전만·표 4·표 7) 준수. **보조 도구 추가 행 원칙 (0.3 준수)**: 임의 표 생성 금지. 기존 표의 새 행으로만 추가하며, 행 제목은 "연속조사: 항목명" 형식. 추가 행도 2칸 구조(`항목 | 내용`) 준수.
  - **변경 내용 표**에 연속조사 추가 행 (행 제목: "연속조사: <항목명>"):
    - 연속조사: 조사 주제·범위 — 조사 주제, 대상 파일 수, 세션 수
    - 연속조사: 발견 건수 — 심각도별(high/mid/low) 발견 건수
    - 연속조사: 보고서 경로 — `docs/조사보고서/<주제>_<날짜>.md`
