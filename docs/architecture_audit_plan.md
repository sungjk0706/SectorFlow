...
> 작성일: 2026-07-11  
> 기준 문서: `ARCHITECTURE.md` (불변 원칙 22개)  
...
> 각 점검 항목에서 해당 원칙 번호(P1~P22)로 평가. 체크박스 ☐ = 미점검, ☑ = 준수, ☒ = 위반.
...
> **우선순위**: P0 (자금 손실 직결)  
> **파일**: 대형 1개 + 중형 1개  
> **대상 원칙**: P1, P2, P5, P7, P14, P15, P16, P18, P20, P22
...
> **우선순위**: P0 (자금 보호)  
> **파일**: 중형 2개  
> **대상 원칙**: P5, P7, P15, P16, P17, P18, P20, P21, P22
...
> **파일**: 대형 1개  
> **대상 원칙**: P1, P2, P5, P14, P15, P16, P18, P20, P22
...
> **우선순위**: P0 (자금 계산 정확성)  
> **파일**: 대형 1개 + 중형 1개  
> **대상 원칙**: P2, P6, P8, P9, P10, P12, P13, P20, P22
...
> **우선순위**: P0 (매매 게이트)  
> **파일**: 소형 2개  
> **대상 원칙**: P5, P10, P11, P13, P17, P18, P21
...
> **우선순위**: P1 (시스템 가동 필수)  
> **파일**: 대형 2개 + 중형 1개  
> **대상 원칙**: P1, P2, P5, P7, P8, P9, P11, P14, P16, P19, P20
...
> **대상 원칙**: P1, P2, P3, P4, P5, P7, P8, P11, P14, P19, P20
...
> **우선순위**: P1 (초기화 및 캐시)  
> **파일**: 중형 3개 + 소형 2개  
> **대상 원칙**: P5, P10, P12, P13, P14, P16, P19, P20
...
> **파일**: 대형 1개 + 중형 2개 + 소형 1개  
> **대상 원칙**: P5, P7, P10, P11, P13, P16, P18, P20
...
> **파일**: 대형 2개 + 중형 2개  
> **대상 원칙**: P2, P4, P5, P10, P13, P16, P19, P20, P21
...
> **파일**: 대형 1개 + 중형 1개  
> **대상 원칙**: P1, P2, P5, P7, P8, P9, P11, P14, P19, P20
...
> **파일**: 대형 1개 + 중형 2개 + 소형 1개  
> **대상 원칙**: P2, P6, P8, P9, P10, P12, P19, P20
...
> **파일**: 대형 1개 + 중형 2개 + 소형 1개  
> **대상 원칙**: P2, P6, P10, P12, P13, P17, P20
...
> **대상 원칙**: P2, P3, P4, P5, P10, P14, P19, P20
...
> **우선순위**: P2 (증권사별 구현)  
> **파일**: 대형 2개 + 중형 3개  
> **대상 원칙**: P1, P2, P3, P4, P5, P7, P14, P19, P20
...
> **대상 원칙**: P7, P10, P13, P16, P18, P20, P22
...
> **우선순위**: P2 (WS 구독 관리)  
> **파일**: 대형 1개 + 중형 1개  
> **대상 원칙**: P4, P5, P7, P10, P11, P13, P16, P20
...
> **우선순위**: P3 (부가 기능)  
> **파일**: 대형 1개 + 소형 1개  
> **대상 원칙**: P2, P5, P14, P16, P19, P20, P21
...
> **대상 원칙**: P2, P5, P10, P14, P16, P19, P20
...
> **대상 원칙**: P2, P5, P10, P12, P13, P16, P19, P20, P21
...
| B-15 | P2 | 증권사 구현: 키움 | ☐ 미시작 |
| B-16 | P2 | 증권사 구현: LS | ☐ 미시작 |
| B-17 | P2 | Domain 계층 | ☐ 미시작 |
