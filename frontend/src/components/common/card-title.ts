/** 카드 제목 — h3 태그 */
import { FONT_SIZE, COLOR, CARD_TITLE_MARGIN_BOTTOM } from './ui-styles'

export function createCardTitle(text: string): HTMLElement {
  const h3 = document.createElement('h3')
  Object.assign(h3.style, { fontSize: FONT_SIZE.title, margin: `0 0 ${CARD_TITLE_MARGIN_BOTTOM}px`, color: `${COLOR.neutral}` })
  h3.textContent = text
  return h3
}
